...
export default {
  async asyncData({ app, req, query, params,store}){
		  const  aboutData = await axios.get(`https://admin.cmereye.com/wp-json/wp/v2/pages/273`);
  ...
  data(){
   ...
   head: {
    ...
    meta: [
      ...
      { hid: 'keywords', name: 'keywords', content: '林顺潮 欧阳伯权 李肖婷 李佑荣 李春山 李国栋 马照祥 陈智亮 梁安妮 叶澍堃' }
