...
<b-dropdown size="sm"   variant="link" toggle-class="text-decoration-none" dropleft  no-caret>
  ...
  <nuxt-link to="/Corporate-culture_en">English</nuxt-link>
      ...
      <div class="banner_about banner_about_culture">
          <div class="banner_text"><p>願景及使命</p></div>
      </div>

      <div class="part_content_bg">
         <b-container fluid="md" class="content part_content part_content_about_culture text-justify">
...
.part_content_about_culture h2{color: #005CAF; font-style: normal; font-weight: 700; font-size: 24px; line-height: 30px; display: flex; align-items: center; letter-spacing: 6px;display: inline-block;border-bottom: 1px solid #005CAF;padding-bottom: 10px;}
...
@media screen and (min-width:992px){
  ...
  .part_History .part_History_item p{font-size: 16px}
...
export default {
  async asyncData({ app, req, query, params,store}){
		  const  aboutData = await axios.get(`https://admin.cmereye.com/wp-json/wp/v2/pages/19`);
  ...
  data(){
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: '以醫療為核心價值; 以病人為中心; 致力於全體團隊成員職業素質的共同提升; 恪守誠實與正直的道德規範; 持續努力、追求卓越。' },
      { hid: 'keywords', name: 'keywords', content: '全方位健康服務 客戶健康 優質服務 保障病人權益 醫療科技 業務里程碑' }
