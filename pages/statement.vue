<template>
  <div class="theme-blue">
    ...
    <div
      class="part_content_bg part_content_contact statement"
      style="height: auto; color: #707070; background: #fff"
    >
...
export default {
  ...
  async asyncData({ app, req, query, params, store }) {
    const disclamerData = await axios.get(
      `https://admin.cmereye.com/wp-json/wp/v2/pages/257`
    );
    return {
  ...
  head: {
    ...
    meta: [
      ...
      },
      {
        ...
        name: "keywords",
        content:
          "3309 希瑪 連鎖專科醫療集團 私隱政策　個人資料收集聲明 資料之目的及用途 資料之轉移 資料之查閱",
      },
    ],
  },
