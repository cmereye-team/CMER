<template>
  <div class="theme-blue tanslate_yin">
    ...
    <template>
      ...
      <div class="banner_about banner_about_board tanslate_yin">
          <div class="banner_text xs_banner_en_text"><p>Board of Directors</p></div>
      </div>
...
export default {
  ...
  async asyncData({ app, req, query, params,store}){
		  const  aboutData = await axios.get(`https://admin.cmereye.com/wp-json/wp/v2/pages/222`);
  ...
  data(){
   ...
   head: {
    title: 'C-MER Board of Directors',
    meta: [
      { charset: 'utf-8' },
      ...
      { hid: 'description', name: 'description', content: 'C-MER Board of Directors' },
      { hid: 'keywords', name: 'keywords', content: 'LAM Shun Chiu Dennis| Rex AUYEUNG Pak-kuen| LI Xiaoting| LEE Yau Wing Vincent| LI Chunshan| LI Kwok Tung Donald| MA Andrew Chiu Cheung| CHAN Chi Leong| BENTLEY Annie Liang| IP Shu Kwan Stephen' }
