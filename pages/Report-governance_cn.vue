...
<nuxt-link to="/Report-governance_en">English</nuxt-link>
 ...
 <div class="page6"><img src="/pic/book2.jpg" alt="" srcset=""></div>
  ...
  <div class="front"><img src="/pic/book19.jpg" alt="" srcset=""></div>
              ...
              <div class="desc flex justify-between flex-col">
                <h2>2021</h2>
                <a class="more text-right"  target="_blank" href="https://admin.cmereye.com/wp-content/uploads/2022/06/20220601cn.pdf">浏览</a> 
              </div>
           </div></b-col>
              <b-col md="6"><div class="part_governance flex justify-between  ">
 ...
 <div class="page6"><img src="/pic/book2.jpg" alt="" srcset=""></div>
  ...
  <div class="front"><img src="/pic/book18.jpg" alt="" srcset=""></div>
              ...
              <div class="desc flex justify-between flex-col">
                <h2>2020</h2>
                <a class="more text-right"  target="_blank" href="https://admin.cmereye.com/themes/grouptemplate_zh-hk/Public/assets/pdf/CW03309%20ESG20.pdf">浏览</a> 
              </div>
           </div></b-col>
           </b-row>
 ...
 <div class="page6"><img src="/pic/book2.jpg" alt="" srcset=""></div>
  ...
  <div class="front"><img src="/pic/book19.jpg" alt="" srcset=""></div>
              ...
              <div class="desc flex justify-between flex-col">
                <h2>2019</h2>
                <a class="more text-right"  target="_blank" href="https://admin.cmereye.com/themes/grouptemplate_zh-hk/Public/assets/pdf/2020062300660_c.pdf">浏览</a> 
              </div>
           </div></b-col>
              <b-col md="6"><div class="part_governance flex justify-between  ">
 ...
 <div class="page6"><img src="/pic/book2.jpg" alt="" srcset=""></div>
  ...
  <div class="front"><img src="/pic/book18.jpg" alt="" srcset=""></div>
              ...
              <div class="desc flex justify-between flex-col">
                <h2>2018</h2>
                <a class="more text-right"  target="_blank" href="https://admin.cmereye.com/themes/grouptemplate_zh-hk/Public/assets/pdf/ltn20190723549_c.pdf">浏览</a> 
              </div>
           </div></b-col>
           </b-row>
  ...
  data(){
   ...
   head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: '查阅最新的希玛环境、社会及管治报告。' },
      { hid: 'keywords', name: 'keywords', content: '环境、社会及管治报告' }
