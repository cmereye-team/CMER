...
export default {
  ...
  async asyncData({ app, req, query, params, store }) {
    const aboutData = await axios.get(
      `https://admin.cmereye.com/wp-json/wp/v2/pages/264`
    );
  ...
  head: {
    ...
    meta: [
      ...
      { name: "robots", content: "index,follow" },
      {
        ...
        name: "description",
        content:
          "希玛眼科医疗控股有限公司 (“希玛”或“本集团”) (股份代号：3309) 为香港及大湾区领先的连锁专科医疗集团，总部设于香港，并于内地多个主要城市建立连锁医院网路。",
      },
      {
        hid: "keywords",
        name: "keywords",
        content:
          "里程碑 希玛 林顺潮 希玛林顺潮眼科中心 希玛微笑激光矫视中心 希玛林顺潮眼科医院 希玛（环球）肿瘤科中心 嘉宾眼科 深圳爱康健齿科 香港上市",
      },
    ],
  },
