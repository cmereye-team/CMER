...
<b-dropdown size="sm"   variant="link" toggle-class="text-decoration-none" dropleft  no-caret>
    <template #button-content> 
     <img src="/img/earth.svg">
        ...
        <nuxt-link to="/Social-Responsibilities">繁体中文</nuxt-link>
     <nuxt-link to="/Social-Responsibilities_cn">简体中文</nuxt-link>
   <nuxt-link to="/Social-Responsibilities_en">English</nuxt-link>
  </b-dropdown>
      ...
      <div class="banner_about banner_about_template banner_about_social tanslate_yin">
          <div class="banner_text xs_banner_en_text"><p>Social Responsibility</p></div>
      </div>
...
<style>
.banner_about_social{background-image:url(/pic/banner_pc_shehui.jpg) !important;}
.part_content_about_template li p{display: inline;}
.part_content_about_template h2{letter-spacing: 5px;}

@media screen and (min-width:992px){

 .social-1-lette{letter-spacing: 0.1em !important;}
...
@media screen and (max-width: 768px){
  ...
  .part_content_about_template .xs-letter-initial{letter-spacing: initial !important;}
  .social_en_left .part_content_about_template p{text-align:left}
}
</style>
...
export default {
  ...
  async asyncData({ app, req, query, params,store}){
		  const  aboutData = await axios.get(`https://admin.cmereye.com/wp-json/wp/v2/pages/246`);
...
head: {
    title: 'C-MER Social Responsibility',
    meta: [
      { charset: 'utf-8' },
      ...
      { hid: 'description', name: 'description', content: 'At C-MER, health advocacy is the heart of what we do in social responsibility. It is our goal to raise public awareness towards the importance of healthy lifestyle for overall wellbeing through the provision of premier medical services. In the meantime, we go beyond CSR by creating shared value to benefit different stakeholders including corporate accomplishments, patients, staff and the community as a whole.  ' },
      { hid: 'keywords', name: 'keywords', content: 'health advocacy| C-MER Social Responsibility| premier medical services| creating shared value| Hong Kong Humanity Award| The Ten Outstanding Young Persons of Hong Kong' }
