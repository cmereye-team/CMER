...
<b-dropdown size="sm"   variant="link" toggle-class="text-decoration-none" dropleft  no-caret>
    <template #button-content> 
     <img src="/img/earth.svg">
      ...
      <b-dropdown-item><nuxt-link to="#">繁體中文</nuxt-link></b-dropdown-item>
    <b-dropdown-item ><nuxt-link to="#">简体中文</nuxt-link></b-dropdown-item> 
   <b-dropdown-item  >  <nuxt-link to="#">English</nuxt-link></b-dropdown-item>
  </b-dropdown>
      ...
      <div class="banner_about banner_Release">
          <div class="banner_text"><h1>News Release</h1><p>新闻稿</p></div>
      </div> 

      <div class="part_content_bg">
         <b-container fluid="md" class="content part_content part_content_Release">
        
        <h2 class="text-2xl text-blue-400 mb-6 text-center">{{newsinfo.title.rendered}}</h2>
...
<style>
.newsinfo p  img{display: inline-block;}
...
@media screen and (max-width:768px) {
 .newsinfo table tr td{display: inline-block;} 
  .newsinfo table,.newsinfo table td{max-width: 100%;width: auto !important;}
  .newsinfo table tr{display: flex;}
  .newsinfo table span{font-size: 14px  !important;}
} 
</style>
