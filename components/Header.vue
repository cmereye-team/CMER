    ...
    >
      <b-navbar-brand to="/" class="flex items-center">
        ...
        <p>
          ...
          <span class="brand_gp" style="font-size: 12px"
            >(股票代號：3309)
          </span>
        </p>
      </b-navbar-brand>
...
.navbar-nav .language .language_box button img {
  max-width: 30px;
}
.statement .part_content p {
  margin-top: 3vw;
}
...
@media screen and (min-width: 992px) {
  ...
  .nav-rightbar {
    ...
    background: linear-gradient(
      180deg,
      #51a8dd 0%,
      rgba(81, 168, 221, 0.03) 100%
    );
    color: #ffffff;
    z-index: 9999;
  }
  .nav-rightbar .scroll_line {
    width: 1px;
    height: 21vh;
    background: #ffffff;
  }
  .nav-rightbar .scroll_textt {
    writing-mode: vertical-rl;
  }
  .nav-rightbar .language {
    position: absolute;
    top: 21px;
  }
  .nav-rightbar .language .language_box {
    position: relative;
  }
  .nav-rightbar .language .language_box .dropdown-menu {
    border: none;
    border-radius: 0;
    background: rgba(255, 255, 255, 0.9);
  }
  .nav-rightbar .language .language_box .dropdown-menu .dropdown-item {
    color: #005caf;
  }
  .nav-rightbar .language .language_box .btn.dropdown-toggle {
    position: relative;
  }
  .nav-rightbar .language .language_box .btn.dropdown-toggle::before {
    position: absolute;
    content: "";
    width: 3px;
    height: 18px;
  ...
  #header_bar.scroll_header {
    padding-top: 0.5rem;
  }

  .navbar-expand-lg .navbar-nav .language .dropdown-menu {
    left: -130px;
    top: 50px;
  }
  .banner_text p {
  ...
  .index .brand_box .brand_card:nth-child(2) img,
  .index .brand_box .brand_card:nth-child(3) img,
  .index .brand_box .brand_card:nth-child(4) img {
    max-height: 70px;
  }
  ...
  .statement .part_content {
    padding: 200px 0;
    text-align: justify;
  }
  .statement .part_content h1 {
    font-size: 40px;
    margin-top: 3vw;
    text-align: left;
  }
...
@media screen and (max-width: 992px) {
  ...
  .navbar-nav .language .language_box {
  ...
  .navbar-nav .language .dropdown-menu a {
    padding: 0.5rem;
  }
  ...
  .navbar-nav .language .language_box .btn-group,
  .navbar-nav .language .language_box .btn-group-vertical {
