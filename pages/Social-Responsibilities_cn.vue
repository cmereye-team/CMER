    ...
    <template #button-content> 
     ...
     <nuxt-link to="/Social-Responsibilities_en">English</nuxt-link>
      ...
      <div class="banner_about banner_about_template banner_about_social">
          <div class="banner_text"><p>社会责任</p></div>
      </div>
...
head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: '健康推广代表著希玛履行社会责任的核心理念。我们的目标是透过优质医疗服务唤起市民关注健康，在改善整体社会福祉的同时，更为不同的持份者，包括集团企业成就、客户、员工，以至社会创造共享价值。' },
      { hid: 'keywords', name: 'keywords', content: '社会责任 优质医疗 香港人道年奖 香港十大杰出青年' }
