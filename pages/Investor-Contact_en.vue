...
<b-dropdown size="sm"   variant="link" toggle-class="text-decoration-none" dropleft  no-caret>
    ...
    <nuxt-link to="/Investor-Contact">繁體中文</nuxt-link>
    <nuxt-link to="/Investor-Contact_cn">简体中文</nuxt-link>
    <nuxt-link to="/Investor-Contact_en">English</nuxt-link>
  </b-dropdown>
    ...
    <div class="banner_about banner_about_contact tanslate_yin">
      <div class="banner_text xs_banner_en_text">
        <p>IR Contact</p>
      </div>
    </div>
    <div class="part_content_bg relative">
      <b-container fluid="md" class="content part_content part_content_about_template mb-20" > 

<div class="text-center tanslate_yin">
   <h4 class="font-bold mt-10 mb-10 tracking-widest">C-MER EYE CARE HOLDINGS LIMITED</h4>
  <p class="mt-10"> &nbsp;</p>
  <h4 class="font-bold mt-10 tracking-widest">Address: </h4>
 <p class="mt-2 tracking-widest">Suite 1535, Central Building, 1-3 Pedder Street, Hong Kong</p>

  <h4 class="font-bold mt-10 tracking-widest">Tel:</h4>
 <p class="mt-2 tracking-widest">(852) 3997 3266</p>

   <h4 class="font-bold mt-10 tracking-widest">Email:</h4>
 <p class="mt-2 tracking-widest">info@hkcmer.com</p>
</div>
...
<style scoped>
.banner_about_contact {
  background-image: url(/pic/banner_pc_contact.jpg);
...
export default {
  ...
  data() {
    return {};
     ...
     head:{
    title: 'C-MER IR Contact',
    meta: [
      { charset: 'utf-8' },
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      {
        name: 'description',
        content: 'C-MER IR Contact'
      },
      {
        name: 'keywords',
        content: 'C-MER| C-MER IR Contact'
      }
    ]
  },
