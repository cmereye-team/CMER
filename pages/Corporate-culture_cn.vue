...
<b-dropdown size="sm"   variant="link" toggle-class="text-decoration-none" dropleft  no-caret>
   ...
   <nuxt-link to="/Corporate-culture_en">English</nuxt-link>
      ...
      <div class="banner_about banner_about_culture">
          <div class="banner_text"><p>愿景及使命</p></div>
      </div>
...
export default {
  async asyncData({ app, req, query, params,store}){
		  const  aboutData = await axios.get(`https://admin.cmereye.com/wp-json/wp/v2/pages/255`);
  ...
  data(){
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: '以医疗为核心价值; 以病人为中心; 致力于全体团队成员职业素质的共同提升; 恪守诚实与正直的道德规范; 持续努力、追求卓越。' },
      { hid: 'keywords', name: 'keywords', content: '全方位健康服务 客户健康 优质服务 保障病人权益 医疗科技 业务里程碑' }
