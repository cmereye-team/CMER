<template>
  <div class="theme-blue tanslate_yin">
    ...
    <div class="part_content_bg tanslate_yin Corporate_en_left">
      <b-container
        fluid="md"
        class="content part_content part_content_about_culture text-justify part_con_en_culture xs_en_part_line1-6"
      >
...
.part_content_about_culture p {
  color: gray;
  line-height: 2.5;
}

.banner_about_culture {
  background-image: url(https://static.cmereye.com/imgs/2023/01/88fe8d3a6dfc21b7.jpg);
}
...
@media screen and (max-width: 991px) {
  .Corporate_en_left .part_content_about_culture p {
    text-align: left;
  }
}
</style>
...
export default {
  ...
  async asyncData({ app, req, query, params, store }) {
    const aboutData = await axios.get(
      `https://admin.cmereye.com/wp-json/wp/v2/pages/213`
    );
  ...
  head: {
    ...
    meta: [
      ...
      { name: "robots", content: "index,follow" },
      {
        ...
        name: "description",
        content:
          "Developing C-MER into a national brand of quality Hong Kong-style medical services.",
      },
      {
        hid: "keywords",
        name: "keywords",
        content:
          "Hong Kong-style medical services| quality specialty medical services| multi-specialties",
      },
    ],
  },
