...
<style>
.zh_cn body,.zh_cn tr,.zh_cn td,.zh_cn th,.zh_cn p,.zh_cn span,.zh_cn a,.zh_cn h1,.zh_cn h2,.zh_cn h3,.zh_cn h4,.zh_cn h5,.zh_cn h6{font-family:Noto Sans CJK TC, serif !important}
