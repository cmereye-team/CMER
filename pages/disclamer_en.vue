...
<b-dropdown size="sm"   variant="link" toggle-class="text-decoration-none" dropleft  no-caret>
   ...
   <nuxt-link to="/disclamer">繁体中文</nuxt-link>
    <nuxt-link to="/disclamer_cn">简体中文</nuxt-link>
   <nuxt-link to="/disclamer_en">English</nuxt-link>
  </b-dropdown>
      ...
      <div class="part_content_bg part_content_contact statement tanslate_yin" style="height:auto;color:#707070;background:#fff">
      <b-container fluid="md" class="content part_content container-md">

      <h1>Disclaimers</h1> 


 <div class="app_info" v-html="disclamerData.content.rendered"></div>
...
export default {
   async asyncData({ app, req, query, params,store}){
		  const  disclamerData = await axios.get(`https://admin.cmereye.com/wp-json/wp/v2/pages/401`);
		  return {
  ...
  data(){ return { } },
  head: {
    title: 'C-MER Eye Care Holdings Limited | C-MER Eye+ | C-MER | Disclaimers',
    meta: [
      { charset: 'utf-8' },
      ...
      { hid: 'keywords', name: 'keywords', content: '3309 C-MER| Chain specialized medical group| Privacy policy|　Personal data collection statement| Purpose and use of data| Transfer of data| Access to information' }
