...
.part_content_about_template h4,
.part_content_about_template h2 {
  font-size: 24px;
  color: #005caf;
}
.part_content_about_template p {
  font-size: 18px;
  color: #707070;
}
...
@media screen and (max-width: 768px) {
  ...
  .Caring_en_left .part_content_about_template p {
    text-align: left;
  }
}
</style>
...
export default {
  ...
  async asyncData({ app, req, query, params, store }) {
    const aboutData = await axios.get(
      `https://admin.cmereye.com/wp-json/wp/v2/pages/241`
    );
  ...
  head: {
    ...
    meta: [
      ...
      { name: "robots", content: "index,follow" },
      {
        ...
        name: "description",
        content:
          "The remarkable achievement of C-MER is attributable to the professionalism and commitment of our staff team. Our work culture:  talent, growth, commitment.",
      },
      {
        hid: "keywords",
        name: "keywords",
        content: "work culture talent growth commitment",
      },
    ],
  },
