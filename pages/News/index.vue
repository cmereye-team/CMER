    ...
    <td> <a class="table-cell"  :href="item.acf.post_pdf_link.url" target="_blank" rel="nofollow"> <p>{{item.title.rendered}}</p></a> </td> </tr>   -->
              <tr>
                ...
                <td>
                  <a
                    class="table-cell"
                    href="https://admin.cmereye.com/wp-content/uploads/2022/09/CMER_1H2022-Interiml-Results-Press-Release_Chi_Final.pdf"
                    target="_blank"
                    rel="nofollow"
                  >
                    <p>
                      希瑪眼科2022年上半年總收益8.82億港元，按年同比增長近70%
                    </p></a
                  >
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <a
                    class="table-cell"
                    href="https://admin.cmereye.com/wp-content/uploads/2022/07/20220329_Chi_Final.pdf"
                    target="_blank"
                    rel="nofollow"
                  >
                    <p>希瑪2021年收益創新高逾11億港元 同比增長59%</p></a
                  >
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <a
                    class="table-cell"
                    href="https://admin.cmereye.com/wp-content/uploads/2022/07/20220216_Chi_Final.pdf"
                    target="_blank"
                    rel="nofollow"
                  >
                    <p>
                      港深攜手同心抗疫 希瑪醫療夥同深圳亞輝龍向香港基層市民
                      捐贈30萬套新冠病毒快速測試包
                    </p></a
                  >
                </td>
              ...
              <tr>
                ...
                <td>
                  ...
                  >
                    <p>
                      香港理工大學與希瑪眼科合作於粵港澳大灣區培育香港年輕視光專才
                    </p></a
                  >
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  ...
                  >
                    <p>
                      「希瑪香港中西腫瘤中心」正式成立並將於2021年9月開始提供服務
                    </p></a
                  >
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  ...
                  >
                    <p>
                      希瑪眼科2020第二季總收入V型反彈，七、八月保持良好恢復勢頭。
                    </p></a
                  >
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  ...
                  >
                    <p>
                      希瑪眼科2019年按計劃穩步發展，總平均收益較去年增長。增長34.2%
                      (香港: 30.7%；內地: 37.8%)
                      因有多間醫院仍在投資期，故利潤較去年微降8.1%
                    </p></a
                  >
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <a
                    class="table-cell"
                    href="https://admin.cmereye.com/wp-content/uploads/2022/07/20180626_Chi_Final.pdf"
                    target="_blank"
                    rel="nofollow"
                  >
                    <p>希瑪眼科獲公益金頒發「公益榮譽獎」</p></a
                  >
                </td>
              </tr>
            </tbody>
...
export default {
  ...
  async asyncData({ app, req, query, params, store }) {
    const newlistData = await axios.get(
      "https://admin.cmereye.com/wp-json/wp/v2/posts?categories=4&page=1"
    );
  ...
  head: {
    ...
    meta: [
      ...
      { name: "robots", content: "index,follow" },
      {
        hid: "description",
        name: "description",
        content: "請閱讀希瑪眼科醫療控股有限公司的新聞稿，了解我們的最新發展。",
      },
...
@media screen and (max-width: 768px) {
  ...
  .lang_news .dropdown-menu {
    display: flex;
  }
  .lang_news .dropdown-menu .dropdown-item {
    padding: 0.25em;
  }
